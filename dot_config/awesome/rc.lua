...
local browser = "google-chrome-stable -no-default-browser-check"
...
globalkeys = mytable.join( -- personal keys
    ...
    -- awful.key({ altkey }, "i", function () awful.util.spawn( ide_idea ) end,
    --     {description = "Capable and Ergonomic IDE for JVM", group = "IDE"}),
